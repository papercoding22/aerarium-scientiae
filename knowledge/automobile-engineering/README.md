...
```mermaid
flowchart LR
  T[English and Vietnamese terms] --> A[Engineering basics]
  A --> B[Main car systems]
  B --> C[How a car behaves]
  C --> D[Maintenance and diagnosis]
  D --> E[Modern and future vehicles]
```
